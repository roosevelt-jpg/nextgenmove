...
/** Operational visa-path shell — one real corridor structure, no fake people. */
const PAGE_VISA_PATH = {
  eyebrow: "Visa path",
...
const OPERATIONAL_SITE_SETTINGS = {
  ...
  // Feature flag: Google OAuth on sign-in / sign-up
  sessionExpireDays: 5,
  ...
  formLabels: {
    ...
    contactSuccessMessage: "Thanks — your message is on its way. We'll reply soon.",
  ...
  pageLabels: {
    ...
    contactMetaDescription: "Contact Nextgenmove by email, phone, or form.",
  ...
  employerPageLabels: {
    ...
    talentPool: {
      ...
      interviewAtLabel: "Date and time",
      ...
      unlockCreditsError: "Could not unlock with credits.",
    ...
    marketplace: {
      ...
      unlockWithCreditsCta: "Unlock with credits",
      maskedEmployerHint:
        "Talent sees an anonymized employer label until identity unlock.",
    },
    jobs: {
      title: "Opportunities",
      postJob: "Post a Job",
      ...
      anonymizedEmployerNote:
        "Talent sees an anonymized employer label on the marketplace until identity unlock is approved.",
      employerLabelPreview: "Talent will see: {label}",
    },
    shortlist: {
    ...
    pipeline: {
      ...
      statPlaced: "Placed",
      funnelTitle: "Hiring funnel by stage",
  ...
  studentPageLabels: {
    dashboard: {
      ...
      topUpAction: "Buy",
      topUpPayCard: "Pay with card",
      topUpBuying: "Starting…",
      topUpRedirecting: "Opening Stripe checkout to enter your card details…",
    ...
    jobs: {
      title: "Marketplace",
      subtitle: "Browse anonymized roles and apply in one click.",
      searchPlaceholder: "Search by title, skill, or location",
      filterLocation: "Location",
      filterType: "Employment type",
      filterSkill: "Skill",
      ...
      revealEmployerPending: "Reveal pending",
      revealEmployerDone: "Employer revealed",
      revealEmployerError: "Could not request employer reveal.",
      maskedEmployerHint:
        "Employer identity is hidden until you request a reveal.",
      typeFullTime: "Full time",
      typePartTime: "Part time",
      typeInternship: "Internship",
      typeFreelance: "Freelance",
    ...
    applications: {
      title: "Applied jobs",
      subtitle: "Track every application from pending to hire.",
      empty: "You have not applied to any jobs yet.",
      loadError: "Could not load applications. Try again.",
      ...
      jobTitleLabel: "Role",
      statusLabel: "Status",
      appliedAtLabel: "Applied",
      openJobBoard: "Browse marketplace →",
      revealEmployerCta: "Reveal employer",
      revealEmployerPending: "Reveal pending",
      revealEmployerDone: "Employer revealed",
      maskedEmployerHint:
    ...
    profile: {
      ...
      profileCompleteness: "Profile {percent}% complete",
      fullName: "Full name",
      sector: "Sector",
      seniority: "Seniority",
      ...
      documentsTitle: "Documents & photo",
      cvUpload: "CV / resume",
      cvDropzone: "PDF or Word (.doc, .docx)",
      cvUploaded: "View uploaded CV",
      photoUpload: "Profile photo",
      photoDropzone: "JPG or PNG",
      uploadProgress: "Uploading…",
      save: "Save profile",
      saveSuccess: "Profile saved.",
      saveError: "Could not save profile.",
      workExperienceEntriesLabel: "Work experience",
      companyLabel: "Company",
      jobTitleLabel: "Title",
      fromLabel: "From",
      toLabel: "To",
      workExperienceDescriptionLabel: "Description",
      addWorkExperienceLabel: "Add experience",
      removeLabel: "Remove",
      invalid_file_type: "Only PDF or Word files are allowed.",
    },
    settings: {
  ...
  adminPageLabels: {
    ...
    content: {
      ...
      filterAll: "All",
      clearFilters: "Clear filters",
      approveJobAction: "Approve",
      rejectJobAction: "Reject",
      companyName: "Company",
      ...
      missionBody: "Mission body (plain text)",
      foundingStory: "Founding story (plain text)",
      ...
      storiesTitle: "Talent stories",
      storiesSubtitle: "Opt-in quotes from placed students — publish after review.",
      visaPath: "Visa path",
      visaPathTitle: "Visa path simulator",
      visaPathSubtitle: "Corridor timelines and required evidence kinds.",
      marketplace: "Marketplace",
      marketplaceTitle: "Marketplace",
      marketplaceSubtitle:
        "Public mutual-privacy copy and shared marketplace CTA labels.",
      marketplaceEyebrow: "Admin · Marketplace",
      ...
      applyCta: "Apply CTA",
      revealEmployerCta: "Reveal employer CTA",
      revealEmployerPending: "Reveal pending",
      revealEmployerDone: "Reveal done",
      maskedEmployerHint: "Masked employer hint",
      unlockTalentCta: "Unlock talent CTA",
      unlockWithCreditsCta: "Unlock with credits CTA",
      empty: "Empty state",
      loadError: "Load error",
      loading: "Loading",
      talentSignUpCta: "Talent sign-up CTA",
      talentSignUpHref: "Talent sign-up href",
      employerRequestCta: "Employer request CTA",
      employerRequestHref: "Employer request href",
      browseRolesCta: "Browse roles CTA",
      browseRolesHref: "Browse roles href",
      body: "Body",
      aboutTitle: "About",
      howItWorksTitle: "How it works",
      pricingTitle: "Pricing",
      ...
      corridorIntelEyebrow: "Corridor intel eyebrow",
      corridorIntelHeadline: "Corridor intel headline",
      corridorIntelSubtext: "Corridor intel subtext",
      corridorIntelSkillsLabel: "Skills label",
      corridorIntelCitiesLabel: "Cities label",
      corridorIntelNationalitiesLabel: "Nationalities label",
      corridorIntelEmptyText: "Corridor intel empty",
      talentStoriesEyebrow: "Talent stories eyebrow",
      talentStoriesHeadline: "Talent stories headline",
      talentStoriesSubtext: "Talent stories subtext",
      talentStoriesManagedLabel: "Talent stories managed label",
      ...
      selectCorridorLabel: "Select corridor label",
      timelineLabel: "Timeline label",
      evidenceLabel: "Evidence label",
      missingEvidenceLabel: "Missing evidence label",
      presentEvidenceLabel: "Present evidence label",
      signInPrompt: "Sign-in prompt",
      signInCta: "Sign-in CTA",
      totalDaysLabel: "Total days label",
      emptyCorridorsText: "Empty corridors text",
      videoUrl: "Video URL",
      youtubeVideoId: "YouTube video id",
      tags: "Tags",
      verifiedPlacement: "Verified placement",
      testimonialsVerifiedLabel: "Verified placement badge",
    ...
    settings: {
      ...
      publishAt: "Schedule publish date",
      publishedAt: "Published at",
      updatedBy: "Last updated by",
      preview: "Preview",
      previewBanner: "Admin preview — not indexed",
      previewDraft: "Draft",
      previewPublished: "Published",
      previewScheduled: "Scheduled (not live yet)",
      previewPublicLink: "Open public URL with preview",
    ...
    levers: {
      ...
      save: "Save",
      loading: "Loading…",
      loadError: "Could not load levers — showing defaults.",
      pendingTitle: "Pending requests",
      ...
      placementFeeEur: "Placement fee (student)",
      trackAMonthly: "Track A monthly (€)",
      trackAMatchFee: "Track A match fee (€)",
      trackBMonthly: "Track B monthly (€)",
      placementFeeEur: "Placement fee (€)",
      creditsPerEuro: "Credits per euro",
      ...
      addRow: "Add row",
      removeRow: "Remove",
      promoteTitle: "Promote to pipeline",
      company: "Company",
      stage: "Stage",
      cancel: "Cancel",
    },
...
async function seedProgramLevers(db: Firestore) {
  ...
  const base = {
    ...
    profileUnlockCredits: existing.profileUnlockCredits ?? 0,
    companyUnlockCredits: existing.companyUnlockCredits ?? 0,
    ...
    companyCreditTopUpPackages: Array.isArray(existing.companyCreditTopUpPackages) &&
    existing.companyCreditTopUpPackages.length
      ? existing.companyCreditTopUpPackages
      : [
          {
            id: "company_pack_200",
            label: "Bench starter",
...
async function seedCmsPages(db: Firestore) {
  const pages: Array<[string, Record<string, unknown>]> = [
    ...
    ["page_visa_path", PAGE_VISA_PATH],
    ["page_marketplace", PAGE_MARKETPLACE],
  ];
