...
export default async function AdminTalentStoriesPage() {
  ...
  return (
    <AdminEntityListView
      ...
      schema={ENTITY_SCHEMAS.talent_stories!}
      title={
        labels.storiesTitle ?? labels.talentStories ?? labels.stories ?? "Talent stories"
      }
    />
  );
}
