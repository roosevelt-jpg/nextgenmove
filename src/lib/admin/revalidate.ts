...
const COLLECTION_REVALIDATE_TAGS: Record<string, string[]> = {
  ...
  testimonials: ["testimonials", "public-cms"],
  talent_stories: ["talent_stories", "public-cms"],
  page_visa_path: ["page_visa_path", "public-cms"],
  page_marketplace: ["page_marketplace", "public-cms"],
...
const COLLECTION_REVALIDATE_PATHS: Record<string, string[]> = {
  ...
  podcast_episodes: ["/"],
  testimonials: ["/"],
  talent_stories: ["/", "/stories"],
  page_visa_path: ["/visa-path", "/student/visa-path"],
  page_marketplace: ["/marketplace", "/student/jobs", "/student/applications"],
  page_about: ["/about"],
