...
export const ENTITY_SCHEMAS: Record<string, AdminEntitySchema> = {
  ...
  page_about: {
    ...
    fields: [
      ...
      { key: "missionBody", type: "textarea", labelKey: "missionBody" },
      {
        key: "statBlocks",
        type: "repeatable",
        labelKey: "statBlocks",
      ...
      { key: "foundingStory", type: "textarea", labelKey: "foundingStory" },
    ],
  },
  page_how_it_works: {
  ...
  page_tracks: {
    ...
    singletonId: "default",
    fields: [
      { key: "trackABody", type: "textarea", labelKey: "trackABody" },
      { key: "trackBBody", type: "textarea", labelKey: "trackBBody" },
      {
        key: "statBlocks",
        type: "repeatable",
        labelKey: "statBlocks",
