...
export const FALLBACK_AUTH_LABELS: AuthLabels = {
  ...
  twoFaEyebrow: "Two-factor authentication",
  twoFaTitle: "Verify it’s you.",
  twoFaSubtitle:
    "Admins need an email or SMS code before entering the workspace.",
  twoFaEmailTab: "Email code",
  twoFaSmsTab: "SMS code",
  twoFaEmailHint: "We’ll send a 6-digit code to your admin email.",
  twoFaSmsHint: "We’ll send a Firebase SMS code to",
  twoFaSend: "Send code",
  twoFaResend: "Resend code",
  twoFaVerify: "Verify & continue",
  phone_not_available: "No phone number on this admin account. Use email code.",
  phone_uid_mismatch: "That phone number is not linked to this account.",
  ...
  otp_locked: "Too many incorrect codes. Request a new one later.",
  ...
  locationSearchHint: "Start typing to search worldwide…",
  ...
  targetCitiesHint: "e.g. Amsterdam, Dubai, Berlin",
  bioLabel: "Short bio",
  ...
  preferredLocationsLabel: "Additional hiring locations (comma-separated)",
  preferredLocationsHint:
    "Optional extra cities — company location above is included automatically",
