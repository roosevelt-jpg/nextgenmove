...
const CONTENT_SECTIONS = [
  ...
  { key: "testimonials", href: "/admin/content/testimonials" },
  { key: "stories", href: "/admin/content/stories" },
  { key: "visaPath", href: "/admin/content/visa-path" },
  { key: "marketplace", href: "/admin/content/marketplace" },
