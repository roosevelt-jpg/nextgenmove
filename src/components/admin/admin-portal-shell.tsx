...
const NAV_ITEMS = [
  ...
  { key: "compliance", href: "/admin/compliance", match: "prefix" as const },
      ...
      <div className="px-3 pt-4">
        ...
        <div className="flex gap-1 rounded-full bg-black/20 p-1 ring-1 ring-white/15">
          <Link
            ...
            className="dashboard-chrome-text flex min-h-7 flex-1 items-center justify-center rounded-full bg-white/10 px-2 text-center text-[11px] font-semibold transition-colors hover:bg-white/18"
          >
          ...
          <Link
            href="/admin/dashboard"
            className="dashboard-chrome-text flex min-h-7 flex-1 items-center justify-center rounded-full bg-white/25 px-2 text-center text-[11px] font-semibold shadow-sm ring-1 ring-white/40"
          >
